...
private:
  ...
  void imu_callback(const sensor_msgs::msg::Imu::SharedPtr imu_msg)
  {
    ...
    // Convert ROS IMU message to our ImuData structure
    ...
    // Since MPU6050 doesn't provide orientation, we'll use identity initially
    // Our integration logic will handle the actual orientation
